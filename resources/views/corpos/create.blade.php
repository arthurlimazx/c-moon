...
@section('title', 'Novo Corpo Celeste')
...
<div class="form-page">
  <div class="page-header animate-up">
    <div class="page-header-text">
      ...
      <h1>Novo corpo celeste</h1>
      <p>Adicione um novo objeto ao catálogo espacial.</p>
    </div>
    <a href="{{ route('corpos.index') }}" class="btn btn-ghost">← Voltar</a>
  </div>

  <div class="form-card animate-up-delay-1">
    <form method="POST" action="{{ route('corpos.store') }}" enctype="multipart/form-data">
      @csrf
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input type="text" id="nome" name="nome"
              ...
              value="{{ old('nome') }}" placeholder="Ex: Marte">
          ...
          <div class="form-group">
            ...
            <input type="text" id="distancia_terra" name="distancia_terra"
              ...
              value="{{ old('distancia_terra') }}" placeholder="Ex: 78,3 milhões km">
          ...
          <div class="form-group">
            ...
            <input type="number" id="diametro_km" name="diametro_km" min="0" step="any"
              ...
              value="{{ old('diametro_km') }}" placeholder="Ex: 6792">
          ...
          <div class="form-group form-group-full">
            ...
            <textarea id="descricao" name="descricao" rows="4"
              ...
              placeholder="Descreva características relevantes do corpo celeste...">{{ old('descricao') }}</textarea>
      ...
      <div class="form-card-footer">
        <a href="{{ route('corpos.index') }}" class="btn btn-ghost">Cancelar</a>
        <button type="submit" class="btn btn-primary">Cadastrar corpo celeste</button>
      </div>
    </form>
  </div>
</div>
